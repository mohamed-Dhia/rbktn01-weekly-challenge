...
// CODE HERE...
string.prototype.grammarPolice = function () { // wrong wrong wrong 
	var split = this.split(' ')

	for (var word in split) {
		split[word][0].toUpperCase();
		for(var i = 1 , i < word.length,i++){
			split[word][i].toLowerCase();
		} 
	}
	split.join(' ');
	return split();
...
// CODE HERE...
var valueType = (value1, value2) => {
	if(value1 === value2){
		return `${value1} and ${value2} are Exactly the same`
	}
	return (value1 == value2) ? `${value1} and ${value2} have Same value but different types` : `${value1} and ${value2} have Different values`
}
...
function large() {
  ...
  // CODE HERE...
  var boundToElephant = large.call(elephant)
// *************
// * PROBLEM 6 *
// *************
...
// CODE HERE...
// var deathStar = function (capacity,crew) {  wrong wrong wrong 
// 	this.capacity = function (crew) {
// 		return object.keys(crew).length;
// 	};
// 	this.crew = {};
// }
// var bound = capacity.call(deathStar,crew) 
